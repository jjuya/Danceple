...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i> 마이 페이지</h3>
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> 회원 정보 수정</h4>
						<form action="updatePage" method="post" class="form-horizontal style-form" >
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 아이디 </label>
                                
                                <div class="col-sm-10">
                                	<p class="form-control-static">${pageIn.userId}</p>
                                	<input type="hidden" id="userId" name="userId" value="${pageIn.userId}" class="form-control"  />
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 이름 </label>
                                
                                <div class="col-sm-10">
                                	<p class="form-control-static">${pageIn.userName}</p>
									<input type="hidden" id="userName" name="userName" value="${pageIn.userName}" class="form-control"  />
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="password" name="nuserPwd" />
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="password" id="nuserPwd2" class="form-control" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 핸드폰 번호 </label>
                                
                                <div class="col-sm-10">
									<input type="text" name="nphone" value="${pageIn.phone}" class="form-control" />
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="text" name="nemail" value="${pageIn.email}" class="form-control" />
								</div>
							</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<input type="text" name="nimgUrl" value="${pageIn.imgUrl}" class="form-control" />
								</div>
							</div>
