			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Edit Season</h4>
						<form action="seasonUpdateAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 시즌 ID </label>
                                
                                <div class="col-sm-10">
                                	<p class="form-control-static">${seasonVO.seasonId}</p>
