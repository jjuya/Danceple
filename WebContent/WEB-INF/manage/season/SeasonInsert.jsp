...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i> 시즌 관리</h3>
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Add Season</h4>
						<form action="seasonInsertAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 시즌 ID </label>
                                
                                <div class="col-sm-10"> 
                                	<input type="text" id="seasonId" name="seasonId" class="form-control" />
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 시즌 월 </label>
								
								<div class="col-sm-10">
									<input type="text" id="snMonth" name="snMonth" class="form-control" />
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 시작 일 </label>
								
								<div class="col-sm-10">
									<input type="text" id="startDate" name="startDate" class="form-control" />
									<span class="help-block">YYYY/MM/DD 형식으로 입력해주세요.</span>
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 종료 일 </label>
