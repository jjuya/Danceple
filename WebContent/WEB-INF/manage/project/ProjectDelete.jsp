	...
	<div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                	<div class="col-lg-7">
						<form action="projectDeleteAction" method="post">
							...
							<div class="form-group">
                                ...
                                <div class="col-lg-10">
                                	...
                                	<input type="hidden" id="projectNo" name="projectNo" value="${projectVO.projectNo}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                	<p class="navbar-text">${projectVO.projectTitle}</p>
                                </div>
                            </div>
