...
<body>
	...
	<section id="main-content">
		<section class="wrapper">
			<h3><i class="fa fa-angle-right"></i> 프로젝트 관리</h3>
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
						<h4 class="mb"><i class="fa fa-angle-right"></i> Add Project</h4>
						<form action="projectInsertAction" method="post" class="form-horizontal style-form">
						
							<div class="form-group">
								<label class="col-lg-2 col-sm-2 control-label"> 프로젝트 번호 </label>
                                
                                <div class="col-sm-10">
                                	<input type="text" id="projectNo" name="projectNo" class="form-control" />
                                </div>
                            </div>
						
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 프로젝트 명 </label>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" id="projectDate" name="projectDate" class="form-control" />
									<span class="help-block">YYYY/MM/DD 형식으로 입력해주세요.</span>
								</div>
							</div>
							
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label"> 설명 </label>
