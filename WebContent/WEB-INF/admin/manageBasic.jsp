							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">
										...
										<a href="<c:url value="/manage/teamInsert" />" class="btn btn-primary">추가</a>
									</h3>
								</div>
										...
										<tbody>
											<c:forEach items="${teamList}" var="team">
												<tr>
													...
													<td>${team.teamUrl}</td>
													<td>
														<a href="<c:url value="/manage/teamUpdate?teamId=${team.teamId}" />" class="btn btn-outline-primary">수정</a> 
														<a href="<c:url value="/manage/teamDelete?teamId=${team.teamId}" />" class="btn btn-mini btn-danger">삭제</a>
													</td>
												</tr>
											</c:forEach>
										</tbody>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h3 class="panel-title">
										...
										<a href="<c:url value="/manage/genreInsert" />" class="btn btn-primary">추가</a>
									</h3>
								</div>
								<div class="panel-body">
									<table class="table table-striped">
										...
										<tbody>
											<c:forEach items="${genreList}" var="genre">
												<tr>
													...
													<td>
														<a href="<c:url value="/manage/genreUpdate?genreId=${genre.genreId} "/>" class="btn btn-outline-primary">수정</a> 
														<a href="<c:url value="/manage/genreDelete?genreId=${genre.genreId}" />" class="btn btn-mini btn-danger">삭제</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
